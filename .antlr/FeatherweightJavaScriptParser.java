// Generated from /Users/lytai1/eclipse-workspace/l_python/FeatherweightJavaScript.g4 by ANTLR 4.8
...
public class FeatherweightJavaScriptParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, IF=7, ELSE=8, VAR=9, PRINT=10, 
		FUNCTION=11, WHILE=12, INT=13, BOOL=14, NULL=15, ID=16, MUL=17, DIV=18, 
		MOD=19, ADD=20, SUB=21, GT=22, GTE=23, LT=24, LTE=25, EQ=26, SEPARATOR=27, 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'('", "')'", "','", "'='", "'{'", "'}'", "'if'", "'else'", "'var'", 
			"'print'", "'function'", "'while'", null, null, "'null'", null, "'*'", 
			"'/'", "'%'", "'+'", "'-'", "'>'", "'>='", "'<'", "'<='", "'=='", "';'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, null, null, null, "IF", "ELSE", "VAR", "PRINT", 
			"FUNCTION", "WHILE", "INT", "BOOL", "NULL", "ID", "MUL", "DIV", "MOD", 
			"ADD", "SUB", "GT", "GTE", "LT", "LTE", "EQ", "SEPARATOR", "NEWLINE", 
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << IF) | (1L << VAR) | (1L << PRINT) | (1L << FUNCTION) | (1L << WHILE) | (1L << INT) | (1L << BOOL) | (1L << NULL) | (1L << ID) | (1L << SEPARATOR))) != 0) );
			}
		}
	...
	public static class EmptExprContext extends StatContext {
		public TerminalNode SEPARATOR() { return getToken(FeatherweightJavaScriptParser.SEPARATOR, 0); }
		public EmptExprContext(StatContext ctx) { copyFrom(ctx); }
	}
	...
	public final StatContext stat() throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				break;
			case 6:
				_localctx = new EmptExprContext(_localctx);
	...
	public static class VarDeclareContext extends ExprContext {
		...
		public VarDeclareContext(ExprContext ctx) { copyFrom(ctx); }
	}
	public static class FunctDeclareContext extends ExprContext {
		...
		public FunctDeclareContext(ExprContext ctx) { copyFrom(ctx); }
	}
	...
	public static class FunctAppContext extends ExprContext {
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
		...
		public FunctAppContext(ExprContext ctx) { copyFrom(ctx); }
	}
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 4:
						{
						_localctx = new FunctAppContext(new ExprContext(_parentctx, _parentState));
						pushNewRecursionContext(_localctx, _startState, RULE_expr);
						setState(86);
						...
						_errHandler.sync(this);
						_la = _input.LA(1);
						if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << VAR) | (1L << FUNCTION) | (1L << INT) | (1L << BOOL) | (1L << NULL) | (1L << ID))) != 0)) {
							{
							setState(88);
							expr(0);
							setState(93);
	...
	public static final String _serializedATN =
		...
		"\4\6\b\2\5\3\2\23\25\3\2\26\27\3\2\30\34\2\u0088\2\13\3\2\2\2\4-\3\2\2"+
		...
		"\34\35\5\6\4\2\35\36\7\4\2\2\36\37\5\b\5\2\37.\3\2\2\2 !\7\16\2\2!\"\7"+
